...
class FixedVariables:
  ...
  # S_IP: ClassVar[str] = "V_14"     # to inputs and outputs
  SELECTION_MATRIX_I_INPUT: ClassVar[str] = "V_9"
  # S_IQ: ClassVar[str] = "V_15"
  SELECTION_MATRIX_I_OUTPUT: ClassVar[str] = "V_10"

  # Identity matrix to switch from T to U in the control arcs
...
# global
  # Identity matrix to switch from N to A in the transport arcs
