...
from packages.Common.classes.io import EntityJSONEncoder
...
def test_dummy():
  ...
  print(json.dumps(test_entity, cls=EntityJSONEncoder, indent=2))
...
def test_real_system():
  ...
  all_eq = load_equations_from_file(path_equations)
