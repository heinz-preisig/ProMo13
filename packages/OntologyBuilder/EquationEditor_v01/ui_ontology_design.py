...
class Ui_OntologyDesigner(object):
    def setupUi(self, OntologyDesigner):
        ...
        self.groupEdit = QtWidgets.QGroupBox(self.groupVariables)
        self.groupEdit.setGeometry(QtCore.QRect(20, 390, 321, 121))
        ...
        self.treeWidget = QtWidgets.QTreeWidget(self.groupVariables)
        self.treeWidget.setGeometry(QtCore.QRect(20, 50, 321, 261))
        self.treeWidget.setObjectName("treeWidget")
        self.treeWidget.headerItem().setText(0, "1")
        self.treeWidget.header().setVisible(False)
        self.pushAddIndex = QtWidgets.QPushButton(self.groupVariables)
        self.pushAddIndex.setGeometry(QtCore.QRect(20, 340, 89, 25))
        self.pushAddIndex.setObjectName("pushAddIndex")
        self.pushManageInterfaceVariables = QtWidgets.QPushButton(self.groupVariables)
        self.pushManageInterfaceVariables.setGeometry(QtCore.QRect(140, 340, 88, 27))
        self.pushManageInterfaceVariables.setObjectName("pushManageInterfaceVariables")
    ...
    def retranslateUi(self, OntologyDesigner):
        ...
        self.pushManageInterfaceVariables.setText(_translate("OntologyDesigner", "interface"))
