...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableVariable.setColumnCount(11)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableVariable.setHorizontalHeaderItem(10, item)
        self.layoutWidget = QtWidgets.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 0, 318, 91))
        ...
        sizePolicy.setHorizontalStretch(40)
        sizePolicy.setVerticalStretch(40)
        sizePolicy.setHeightForWidth(self.pushNext.sizePolicy().hasHeightForWidth())
        self.pushNext.setSizePolicy(sizePolicy)
        self.pushNext.setMinimumSize(QtCore.QSize(40, 40))
        self.pushNext.setMaximumSize(QtCore.QSize(40, 40))
    ...
    def retranslateUi(self, Dialog):
        ...
        item = self.tableVariable.horizontalHeaderItem(10)
        item.setText(_translate("Dialog", "IRI"))
