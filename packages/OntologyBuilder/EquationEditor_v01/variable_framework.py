...
class Variables(OrderedDict):
    ...
    def variableSpaces(self, what, network, enabled_variable_types):
        ...
        if what == "variable_picking":
            ...
            # Add current domain variables
            if network in self.index_networks_for_variable:
                variable_space[network] = {}
                for var_class in self.index_networks_for_variable[network]:
                    variable_space[network][var_class] = set()
                    for v in self.index_networks_for_variable[network][var_class]:
