...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 90, 131, 61))
        ...
        self.radioButtonIsEnableAddingIndex.setGeometry(QtCore.QRect(10, 170, 201, 22))
        ...
        self.radioButtonNormedDomain = QtWidgets.QRadioButton(self.groupBoxNetwork)
        self.radioButtonNormedDomain.setGeometry(QtCore.QRect(10, 190, 201, 22))
        self.radioButtonNormedDomain.setToolTip("")
        self.radioButtonNormedDomain.setAutoExclusive(False)
        self.radioButtonNormedDomain.setObjectName("radioButtonNormedDomain")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(40, 290, 1021, 361))
        ...
        self.groupBoxStructureRules = QtWidgets.QGroupBox(self.tab_structure)
        self.groupBoxStructureRules.setGeometry(QtCore.QRect(780, 30, 231, 151))
        self.groupBoxStructureRules.setObjectName("groupBoxStructureRules")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.groupBoxStructureRules)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 40, 231, 83))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.radioButtonAllowsInjection = QtWidgets.QRadioButton(self.verticalLayoutWidget_2)
        self.radioButtonAllowsInjection.setToolTip("")
        self.radioButtonAllowsInjection.setAutoExclusive(False)
        self.radioButtonAllowsInjection.setObjectName("radioButtonAllowsInjection")
        self.verticalLayout_6.addWidget(self.radioButtonAllowsInjection)
        self.radioButtonAllowsTokenConversion = QtWidgets.QRadioButton(self.verticalLayoutWidget_2)
        self.radioButtonAllowsTokenConversion.setToolTip("")
        self.radioButtonAllowsTokenConversion.setAutoExclusive(False)
        self.radioButtonAllowsTokenConversion.setObjectName("radioButtonAllowsTokenConversion")
        self.verticalLayout_6.addWidget(self.radioButtonAllowsTokenConversion)
        ...
        self.groupBoxBehaviourRules = QtWidgets.QGroupBox(self.tab_behaviour)
        ...
        self.radioButtonHasPortVariables = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        ...
        self.verticalLayout_5.addWidget(self.radioButtonHasPortVariables)
        self.radioButtonHasPersistantVariables = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.radioButtonHasPersistantVariables.setToolTip("")
        self.radioButtonHasPersistantVariables.setAutoExclusive(False)
        self.radioButtonHasPersistantVariables.setObjectName("radioButtonHasPersistantVariables")
        self.verticalLayout_5.addWidget(self.radioButtonHasPersistantVariables)
        self.radioButtonAreConstants = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.radioButtonAreConstants.setToolTip("")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButtonNormedDomain.setText(_translate("MainWindow", "is normed domain"))
        ...
        self.groupBoxStructureRules.setTitle(_translate("MainWindow", "node rules"))
        self.radioButtonAllowsInjection.setText(_translate("MainWindow", "allow injection"))
        self.radioButtonAllowsTokenConversion.setText(_translate("MainWindow", "allows token conversion"))
        ...
        self.groupBoxBehaviourRules.setTitle(_translate("MainWindow", "variable rules"))
