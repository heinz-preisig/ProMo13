...
class MainModel(QtCore.QObject):
    ...
    def __init__(self) -> None:
        super().__init__()
        self._io_manager = io.IOManager()
        # Remove when the user have the option to change the repository
        self._io_manager.set_repository_location("../../Ontology_Repository")
    ...
    def get_available_ontologies(self) -> list[str]:
        return self._io_manager.get_context_member_valid_options(
