...
_lr_productions = [
  ...
  ('expression -> expression O_PLUS expression','expression',3,'p_expr_plus','equation_parser.py',130),
  ('expression -> expression O_MINUS expression','expression',3,'p_expr_minus','equation_parser.py',134),
  ('expression -> O_MINUS expression','expression',2,'p_expr_uminus','equation_parser.py',138),
  ('expression -> expression O_DOT expression','expression',3,'p_expr_expand_product','equation_parser.py',142),
  ('expression -> expression O_COLON expression','expression',3,'p_expr_khatri_rao','equation_parser.py',146),
  ('expression -> expression O_PIPE INDEX O_PIPE expression','expression',5,'p_expr_reduce_product','equation_parser.py',150),
  ('expression -> expression O_PIPE INDEX O_IN INDEX O_PIPE expression','expression',7,'p_expr_block_reduce_product','equation_parser.py',155),
  ('expression -> expression O_HAT expression','expression',3,'p_expr_power','equation_parser.py',162),
  ('expression -> D_LEFT_ROUND expression D_RIGHT_ROUND','expression',3,'p_expr_parentheses','equation_parser.py',166),
  ('expression -> UNARY_FUNCTION D_LEFT_ROUND expression D_RIGHT_ROUND','expression',4,'p_unary_function','equation_parser.py',170),
  ('expression -> BINARY_FUNCTION D_LEFT_ROUND expression D_COMMA expression D_RIGHT_ROUND','expression',6,'p_binary_function','equation_parser.py',174),
  ('expression -> QUATERNARY_FUNCTION D_LEFT_ROUND expression D_COMMA expression D_COMMA expression D_COMMA expression D_RIGHT_ROUND','expression',10,'p_quaternary_function','equation_parser.py',178),
]
