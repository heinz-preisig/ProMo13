...
TEMPLATE_ARC_APPLICATION = "%s" + ARC_COMPONENT_SEPARATOR + \
    "%s" + ARC_COMPONENT_SEPARATOR + "%s"  # %(token, mechanism, nature)

# Templates for intraconnections (needed for ontology processing)
TEMPLATE_INTRACONNECTION_PAIRS = "%s" + ENTITY_OBJECT_SEPARATOR + "%s"
TEMPLATE_INTRACONNECTION_NETWORK = "%s" + ENTITY_OBJECT_SEPARATOR + "%s"
