...
# DEPRECATED: Old CONNECTION_NETWORK_SEPARATOR = " >>> " - replaced by unified interface system
# Legacy interfaces still supported during transition period
CONNECTION_NETWORK_SEPARATOR = " >>> "  # Legacy support only
CONVERSION_SEPARATOR = " --> "
EXTENSION_DUPLICATES_REMOVED = "-D"
TOKEN_DELIMITER = "_"
PROMO_IRI_PREFIX = "promo:"
VARIABLE_TYPE_INTERFACE = "interface"
...
# DEPRECATED: Legacy interface templates - replaced by standard ontology domain processing
TEMPLATE_INTERCONNECTION_NETWORK = "%s" + CONNECTION_NETWORK_SEPARATOR + "%s"  # Legacy only
TEMPLATE_INTRACONNECTION_NETWORK = "%s" + CONNECTION_NETWORK_SEPARATOR + "%s"  # Legacy only
TEMPLATE_INTRACONNECTION_PAIRS = "%s" + CONNECTION_NETWORK_SEPARATOR + "%s"  # Legacy only
TEMPLATE_CONNECTION_NETWORK = "%s" + CONNECTION_NETWORK_SEPARATOR + "%s"  # Legacy only
...
VARIABLE_TYPE_RESIDUAL = "residual"
...
def askForModelFileGivenOntologyLocation(model_library_location, alternative, **kwargs):
                                         # left_icon="new",
                                         # left_tooltip="new",
                                         # center_icon="reject",
                                         # centre_tooltip = "reject",
                                         # right_icon="accept",
...
def getOntologyName(new=False, task="ProMo_logo", behaviour="on_click"): #, left_icon="reject", right_icon="accept"):
  ...
  ontology, state = selectFromList("choose ontology", ontologies,
                                   ...
                                   # # center_icon=None, center_tooltip = None,
...
def selectFromList(title, items,**kwargs):
                   # left_icon=None, left_tooltip=None,
                   # center_icon=None, center_tooltip=None,
                   # right_icon=None, right_tooltip=None):
  items.sort()
  selector = SingleListSelector(items, **kwargs)
